...
export default async function CaseStudyPage({
  ...
  return (
    <div className="mx-auto max-w-4xl px-6">
      {/* Header */}
      <div className="pt-20 pb-20 border-b border-earth-200">
        <Link
          href="/it"
      ...
      <div className="space-y-16 py-16">
        ...
        <div className="grid gap-x-16 gap-y-10 sm:grid-cols-2">
          ...
          <section className="border-t-2 border-navy-400 pt-7">
          ...
          <div className="mt-8 space-y-8">
            {project.technicalDetails.map((section) => (
              <div key={section.label}>
                <h3 className="mb-3 text-xs font-medium uppercase tracking-widest text-navy-500">
                  {section.label}
                </h3>
