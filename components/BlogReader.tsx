        ...
        <aside className="w-60 flex-shrink-0 overflow-y-auto border-l border-earth-200 bg-earth-50 px-6 py-8">
          ...
          <div className="space-y-0">
            <button
              ...
              className={`flex w-full items-center justify-between border-t border-earth-100 py-3 text-left text-sm transition-colors first:border-0 ${
                topicFilter === null && tagFilter === null ? "text-earth-900 font-medium" : "text-earth-500 hover:text-earth-800"
              }`}
            >
              <span>All</span>
            ...
            {topicCounts.map(({ topic, count }) => (
              <button
                ...
                className={`flex w-full items-center justify-between border-t border-earth-100 py-3 text-left text-sm transition-colors ${
                  topicFilter === topic ? "text-terracotta-600 font-medium" : "text-earth-500 hover:text-earth-800"
                }`}
              >
          ...
          {activeSelected && (
            <div className="mt-8 border-t border-earth-200 pt-8">
              ...
              <p className="mt-3 text-xs text-earth-500">{activeSelected.displayDate}</p>
          ...
          <div className="mt-8 border-t border-earth-200 pt-8">
            ...
            <p className="text-xs leading-relaxed text-earth-500">
              Written by Julian Ruiz Burgos — ecologist, IT consultant, and amateur photographer based in the UK.
            </p>
          </div>
        </aside>
      </div>
