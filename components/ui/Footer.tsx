...
export default function Footer() {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 z-20 border-t border-earth-200 bg-earth-50/95 backdrop-blur-sm">
      <div className="mx-auto max-w-6xl px-6 py-3 text-sm text-earth-600">
